  ...
  ui: function(params, cb) {
    ...
    if (FB._nativeInterface) {
        switch (params.method) {
            case 'auth.login':
                FB._nativeInterface.login(params, cb, function(e) {alert('No se ha podido conectar a Facebook, por favor revise su conexion ' + e);});
                break;
...
FB.provide('', {
   ...
   */
  init: function(options, failCallback) {
    ...
    failCallback = failCallback || function(e) {alert('Cordova Facebook Connect plugin fail on init!');};
    ...
    if (FB._nativeInterface) {
      FB._nativeInterface.init(FB._apiKey, failCallback);
    }
